...
import static org.opengis.cite.ogcapifeatures10part2.openapi3.OpenApiUtils.PATH.COLLECTIONS;
import static org.opengis.cite.ogcapifeatures10part2.openapi3.OpenApiUtils.PATH.CONFORMANCE;
...
public class OpenApiUtils {
    ...
    public static List<TestPoint> retrieveTestPointsForCollections( OpenApi3 apiModel, URI iut, int noOfCollection ) {
        ...
        if(noOfCollection < 0 && allTestPoints.size() > OgcApiFeatures10Part2.COLLECTIONS_LIMIT) {
            return allTestPoints.subList( 0, OgcApiFeatures10Part2.COLLECTIONS_LIMIT );
