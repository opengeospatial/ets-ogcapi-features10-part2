...
import static org.opengis.cite.ogcapifeatures10part2.OgcApiFeatures10Part2.DEFAULT_CRS_WITH_HEIGHT;
...
public class EtsAssert {
    ...
    public static CoordinateSystem assertDefaultCrs( List<String> valueToAssert, String failureMsg ) {
        if ( valueToAssert.contains( OgcApiFeatures10Part2.DEFAULT_CRS_CODE ) )
            return DEFAULT_CRS;
        if ( valueToAssert.contains( OgcApiFeatures10Part2.DEFAULT_CRS_WITH_HEIGHT_CODE ) )
    ...
    public static void assertDefaultCrsAtFirst( List<String> valueToAssert, String failureMsg ) {
        if ( !valueToAssert.isEmpty() ) {
            ...
            if ( OgcApiFeatures10Part2.DEFAULT_CRS_CODE.equals( firstCrs ) )
                return;
            if ( OgcApiFeatures10Part2.DEFAULT_CRS_WITH_HEIGHT_CODE.equals( firstCrs ) )
                return;
        }
        throw new AssertionError( failureMsg );
    }
    ...
    public static void assertDefaultCrs( String crsHeaderValue, String failureMsg ) {
        if ( !crsHeaderValue.matches( "<" + OgcApiFeatures10Part2.DEFAULT_CRS_CODE + ">" )
             && !crsHeaderValue.matches( "<" + OgcApiFeatures10Part2.DEFAULT_CRS_WITH_HEIGHT_CODE + ">" ) ) {
            throw new AssertionError( failureMsg );
        }
    }
