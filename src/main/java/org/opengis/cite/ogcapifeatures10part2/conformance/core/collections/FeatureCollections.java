...
import static org.opengis.cite.ogcapifeatures10part2.EtsAssert.assertDefaultCrs;
import static org.opengis.cite.ogcapifeatures10part2.EtsAssert.assertDefaultCrsAtFirst;
import static org.opengis.cite.ogcapifeatures10part2.EtsAssert.assertTrue;
import static org.opengis.cite.ogcapifeatures10part2.OgcApiFeatures10Part2.DEFAULT_CRS_CODE;
import static org.opengis.cite.ogcapifeatures10part2.OgcApiFeatures10Part2.DEFAULT_CRS_WITH_HEIGHT_CODE;
import static org.opengis.cite.ogcapifeatures10part2.conformance.SuiteAttribute.IUT;
import static org.opengis.cite.ogcapifeatures10part2.openapi3.OpenApiUtils.retrieveTestPointsForCollectionsMetadata;
...
import static org.opengis.cite.ogcapifeatures10part2.util.JsonUtils.parseAsListOfMaps;
import static org.opengis.cite.ogcapifeatures10part2.util.JsonUtils.parseAsString;
...
import org.opengis.cite.ogcapifeatures10part2.openapi3.UriBuilder;
    ...
    private List<Map<String, Object>> createCollectionsMap( List<Object> collections ) {
        ...
        for (Object collectionObj : collections) {
            ...
            if (null != collection.get("id")) {
                ...
                } else if (collectionsMap.size() >= OgcApiFeatures10Part2.COLLECTIONS_LIMIT) {
                    return collectionsMap.subList( 0, OgcApiFeatures10Part2.COLLECTIONS_LIMIT );
                }
            }
        }
        return collectionsMap;
