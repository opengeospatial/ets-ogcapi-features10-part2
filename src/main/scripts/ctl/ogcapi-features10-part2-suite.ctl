...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
             ...
             xmlns:tng="java:org.opengis.cite.ogcapifeatures10part2.TestNGController">
  ...
  <ctl:suite name="tns:ets-${ets-code}-${version}">
    <ctl:title>OGC API - Features - Part 2 Conformance Test Suite</ctl:title>
    ...
    <ctl:code>
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          <h2>OGC API - Features - Part 2 Conformance Test Suite</h2>
