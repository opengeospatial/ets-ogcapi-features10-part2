...
import static org.opengis.cite.ogcapifeatures10part2.EtsAssert.assertCrsHeader;
...
import static org.opengis.cite.ogcapifeatures10part2.EtsAssert.assertValidCrsIdentifier;
...
import org.opengis.cite.ogcapifeatures10part2.util.JsonUtilsTest;
...
public class EtsAssertTest {
    ...
    public void testAssertDefaultCrs() {
        CoordinateSystem defaultCrs = assertDefaultCrs( Arrays.asList( "urn:test:crs:CRS84",
                                                                       OgcApiFeatures10Part2.DEFAULT_CRS_CODE ),
                                                        "OK" );
        Assert.assertThat( defaultCrs, is( OgcApiFeatures10Part2.DEFAULT_CRS ) );
    }
    ...
    public void testAssertDefaultCrsAtFirst() {
        assertDefaultCrsAtFirst( Arrays.asList( OgcApiFeatures10Part2.DEFAULT_CRS_CODE, "urn:test:crs:CRS84" ), "OK" );
    }

    @Test(expected = AssertionError.class)
    public void testAssertDefaultCrsAtFirst_firstNotDefault() {
        assertDefaultCrsAtFirst( Arrays.asList( "urn:test:crs:CRS84", OgcApiFeatures10Part2.DEFAULT_CRS_CODE ), "FAIlURE" );
    }
