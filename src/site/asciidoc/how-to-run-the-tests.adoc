...
As entry point the Landing Page of the OGC API - Features - Part 2: CRS by Reference is expected.

=== 1. Integrated development environment (IDE)

Use a Java IDE such as Eclipse, NetBeans, or IntelliJ. Clone the repository and build the project.

Set the main class to run: `org.opengis.cite.ogcapifeatures10part2.TestNGController`
...
`java -jar ets-ogcapi-features10-part2-0.1-SNAPSHOT-aio.jar [-o|--outputDir $TMPDIR] [test-run-props.xml]`
